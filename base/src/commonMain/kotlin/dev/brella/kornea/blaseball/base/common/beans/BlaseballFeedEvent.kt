        ...
        decoder.decodeStructure(descriptor) {
            ...
            while (true) {
                when (val index = decodeElementIndex(descriptor)) {
                    ...
                    descriptor.getElementIndex("created") -> builder.created = Instant.parse(decodeStringElement(descriptor, index))
...
//                println("==[Json Hacked]==")
    ...
    override fun serialize(encoder: Encoder, value: BlaseballFeedEvent) {
        encoder.encodeStructure(descriptor) {
            ...
            encodeStringElement(descriptor, descriptor.getElementIndex("created"), value.created.toString())
